...
//    public AccountViewResponse soapRequest(String soapMessage){
//        SOAPConnectionFactory soapConnectionFactory = null;
//        try {
//            soapConnectionFactory = SOAPConnectionFactory.newInstance();
//            SOAPConnection soapConnection = soapConnectionFactory.createConnection();
//            SOAPMessage responseMassage=soapConnection.call(getSoapMessageFromString(soapMessage), PathString.MMT_URL);
//            AccountViewResponse accountResponse=  this.accountView(responseMassage);
//
...
//        org.w3c.dom.Node node=this.getSoapBody(soapBody);
...
//            try{
//                org.w3c.dom.Node detailNode= (Node) node.getChildNodes().item(1).getChildNodes().item(0).getChildNodes().item(0).getChildNodes();
